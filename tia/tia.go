...
type Chip struct {
	...
	shadowColors                  [4]color.RGBA             // Shadow regs of colors to load on TickDone().
	...
	color                         color.RGBA                // Color for current pixel value. Copied into here to avoid heap allocations per pixel.
	scaleFactor                   int                       // An integer scaling factor for drawing into the Image.
...
func Init(def *ChipDef) (*Chip, error) {
	...
	if def.Image == nil {
		return nil, errors.New("Image must be non-nil")
	}
	...
	scale := def.ScaleFactor
	if scale == 0 {
		scale = 1
	}
	rect := def.Image.Bounds()
	if rect.Min.X != 0 || rect.Max.X < (w*scale) || rect.Min.Y != 0 || rect.Max.Y < (h*scale) {
		return nil, fmt.Errorf("Image not sufficient size. X must be at least 0-%d and Y 0-%d and Image is %+v", (w * scale), (h * scale), rect)
	}
	...
	// and just skip it.
	for x := 0; x < (w * t.scaleFactor); x++ {
		for y := 0; y < (h * t.scaleFactor); y++ {
...
func (t *Chip) Tick() error {
	...
	t.color = t.colors[kBackgroundColor]
	...
	for i := 0; i < t.scaleFactor; i++ {
		for j := 0; j < t.scaleFactor; j++ {
			// Pass color along by pointer since as an interface this escapes to the heap
			// but is better than passing by value which generates tons of garbage.
			t.picture.Set((w*t.scaleFactor)+i, (h*t.scaleFactor)+j, &t.color)
		}
	}
	return nil
}
...
var (
	...
	kNTSC = [128]color.RGBA{
		...
		color.RGBA{0x1D, 0x00, 0x00, 0xFF}, // Gold
		color.RGBA{0x3E, 0x1E, 0x00, 0xFF},
		color.RGBA{0x61, 0x41, 0x00, 0xFF},
		color.RGBA{0x86, 0x65, 0x00, 0xFF},
		color.RGBA{0xAB, 0x8A, 0x00, 0xFF},
		color.RGBA{0xCF, 0xB1, 0x00, 0xFF},
		color.RGBA{0xF4, 0xD7, 0x00, 0xFF},
		color.RGBA{0xF9, 0xFF, 0x29, 0xFF},
		color.RGBA{0x3D, 0x00, 0x00, 0xFF}, // Orange
		color.RGBA{0x67, 0x00, 0x00, 0xFF},
		color.RGBA{0x8F, 0x17, 0x00, 0xFF},
		color.RGBA{0xB7, 0x3F, 0x00, 0xFF},
		color.RGBA{0xDE, 0x65, 0x00, 0xFF},
		color.RGBA{0xFF, 0x8A, 0x00, 0xFF},
		color.RGBA{0xFF, 0xB4, 0x0C, 0xFF},
		color.RGBA{0xFF, 0xE3, 0x65, 0xFF},
		color.RGBA{0x4F, 0x00, 0x00, 0xFF}, // Bright orange
		color.RGBA{0x7F, 0x00, 0x00, 0xFF},
		color.RGBA{0xA7, 0x00, 0x00, 0xFF},
		color.RGBA{0xD0, 0x06, 0x00, 0xFF},
		color.RGBA{0xF8, 0x3C, 0x0F, 0xFF},
		color.RGBA{0xFF, 0x66, 0x44, 0xFF},
		color.RGBA{0xFF, 0x94, 0x78, 0xFF},
		color.RGBA{0xFF, 0xC2, 0xB8, 0xFF},
		color.RGBA{0x4C, 0x00, 0x00, 0xFF}, // Pink
		color.RGBA{0x7B, 0x00, 0x15, 0xFF},
		color.RGBA{0xA6, 0x00, 0x38, 0xFF},
		color.RGBA{0xCE, 0x00, 0x5B, 0xFF},
		color.RGBA{0xF7, 0x00, 0x7E, 0xFF},
		color.RGBA{0xFF, 0x44, 0xA4, 0xFF},
		color.RGBA{0xFF, 0x76, 0xD4, 0xFF},
		color.RGBA{0xFF, 0xAA, 0xF5, 0xFF},
		color.RGBA{0x36, 0x00, 0x4A, 0xFF}, // Purple
		color.RGBA{0x63, 0x00, 0x67, 0xFF},
		color.RGBA{0x8E, 0x00, 0x8C, 0xFF},
		color.RGBA{0xB5, 0x00, 0xB1, 0xFF},
		color.RGBA{0xDE, 0x00, 0xD7, 0xFF},
		color.RGBA{0xFF, 0x20, 0xFE, 0xFF},
		color.RGBA{0xFF, 0x6C, 0xF5, 0xFF},
		color.RGBA{0xFF, 0xA8, 0xF6, 0xFF},
		color.RGBA{0x26, 0x00, 0x84, 0xFF}, // Purple-blue
		color.RGBA{0x47, 0x00, 0xA4, 0xFF},
		color.RGBA{0x6B, 0x00, 0xCB, 0xFF},
		color.RGBA{0x90, 0x00, 0xF3, 0xFF},
		color.RGBA{0xB3, 0x00, 0xFF, 0xFF},
		color.RGBA{0xD8, 0x4E, 0xFF, 0xFF},
		color.RGBA{0xFE, 0x82, 0xFE, 0xFF},
		color.RGBA{0xFF, 0xB5, 0xF8, 0xFF},
		color.RGBA{0x24, 0x00, 0x93, 0xFF}, // Blue
		color.RGBA{0x34, 0x00, 0xC0, 0xFF},
		color.RGBA{0x4A, 0x00, 0xE7, 0xFF},
		color.RGBA{0x63, 0x00, 0xFF, 0xFF},
		color.RGBA{0x7D, 0x43, 0xFF, 0xFF},
		color.RGBA{0x9B, 0x79, 0xFF, 0xFF},
		color.RGBA{0xBE, 0xA7, 0xFF, 0xFF},
		color.RGBA{0xE3, 0xD4, 0xFF, 0xFF},
		color.RGBA{0x1A, 0x00, 0x73, 0xFF}, // Blue
		color.RGBA{0x29, 0x00, 0xAD, 0xFF},
		color.RGBA{0x30, 0x00, 0xD9, 0xFF},
		color.RGBA{0x3C, 0x3E, 0xFF, 0xFF},
		color.RGBA{0x44, 0x72, 0xFF, 0xFF},
		color.RGBA{0x5B, 0x9F, 0xFF, 0xFF},
		color.RGBA{0x77, 0xCD, 0xFF, 0xFF},
		color.RGBA{0x9A, 0xF9, 0xFF, 0xFF},
		color.RGBA{0x03, 0x08, 0x3B, 0xFF}, // Light blue
		color.RGBA{0x01, 0x2A, 0x6F, 0xFF},
		color.RGBA{0x00, 0x4D, 0xA4, 0xFF},
		color.RGBA{0x00, 0x73, 0xCB, 0xFF},
		color.RGBA{0x00, 0x99, 0xF2, 0xFF},
		color.RGBA{0x00, 0xC1, 0xFF, 0xFF},
		color.RGBA{0x00, 0xED, 0xFF, 0xFF},
		color.RGBA{0x5A, 0xFF, 0xFF, 0xFF},
		color.RGBA{0x00, 0x22, 0x03, 0xFF}, // Turquoise
		color.RGBA{0x00, 0x47, 0x28, 0xFF},
		color.RGBA{0x00, 0x6D, 0x59, 0xFF},
		color.RGBA{0x00, 0x92, 0x7C, 0xFF},
		color.RGBA{0x00, 0xB7, 0xA1, 0xFF},
		color.RGBA{0x00, 0xDE, 0xC7, 0xFF},
		color.RGBA{0x00, 0xFF, 0xED, 0xFF},
		color.RGBA{0x45, 0xFF, 0xFF, 0xFF},
		color.RGBA{0x00, 0x27, 0x04, 0xFF}, // Green blue
		color.RGBA{0x00, 0x4F, 0x08, 0xFF},
		color.RGBA{0x00, 0x77, 0x11, 0xFF},
		color.RGBA{0x00, 0x9E, 0x2F, 0xFF},
		color.RGBA{0x00, 0xC5, 0x4F, 0xFF},
		color.RGBA{0x00, 0xEC, 0x71, 0xFF},
		color.RGBA{0x00, 0xFF, 0x95, 0xFF},
		color.RGBA{0x5F, 0xFF, 0xB7, 0xFF},
		color.RGBA{0x00, 0x24, 0x03, 0xFF}, // Green
		color.RGBA{0x00, 0x4B, 0x06, 0xFF},
		color.RGBA{0x00, 0x72, 0x05, 0xFF},
		color.RGBA{0x00, 0x99, 0x07, 0xFF},
		color.RGBA{0x00, 0xC0, 0x10, 0xFF},
		color.RGBA{0x00, 0xE7, 0x2B, 0xFF},
		color.RGBA{0x3D, 0xFF, 0x4A, 0xFF},
		color.RGBA{0x9B, 0xFF, 0x67, 0xFF},
		color.RGBA{0x00, 0x17, 0x01, 0xFF}, // Yellow green
		color.RGBA{0x00, 0x3A, 0x01, 0xFF},
		color.RGBA{0x13, 0x5E, 0x00, 0xFF},
		color.RGBA{0x3C, 0x84, 0x00, 0xFF},
		color.RGBA{0x5F, 0xAB, 0x00, 0xFF},
		color.RGBA{0x83, 0xD2, 0x00, 0xFF},
		color.RGBA{0xA8, 0xF9, 0x03, 0xFF},
		color.RGBA{0xD8, 0xFF, 0x2E, 0xFF},
		color.RGBA{0x1E, 0x00, 0x00, 0xFF}, // Orange green
		color.RGBA{0x3F, 0x1E, 0x00, 0xFF},
		color.RGBA{0x62, 0x41, 0x00, 0xFF},
		color.RGBA{0x87, 0x65, 0x00, 0xFF},
		color.RGBA{0xAC, 0x8A, 0x00, 0xFF},
		color.RGBA{0xD1, 0xB1, 0x00, 0xFF},
		color.RGBA{0xF7, 0xD7, 0x00, 0xFF},
		color.RGBA{0xF9, 0xFF, 0x29, 0xFF},
		color.RGBA{0x3E, 0x00, 0x00, 0xFF}, // Light orange
		color.RGBA{0x68, 0x00, 0x00, 0xFF},
		color.RGBA{0x90, 0x16, 0x00, 0xFF},
		color.RGBA{0xB8, 0x3F, 0x00, 0xFF},
		color.RGBA{0xDF, 0x63, 0x00, 0xFF},
		color.RGBA{0xFF, 0x8A, 0x00, 0xFF},
		color.RGBA{0xFF, 0xB4, 0x0F, 0xFF},
		color.RGBA{0xFF, 0xE3, 0x66, 0xFF},
	}
	kPAL = [128]color.RGBA{
		color.RGBA{0x00, 0x00, 0x00, 0xFF}, // Grey
		color.RGBA{0x1A, 0x1A, 0x1A, 0xFF},
		...
		color.RGBA{0xC7, 0xC7, 0xC7, 0xFF},
		color.RGBA{0xED, 0xED, 0xED, 0xFF},
		color.RGBA{0x23, 0x00, 0x00, 0xFF}, // Gold
		color.RGBA{0x44, 0x1A, 0x00, 0xFF},
		color.RGBA{0x68, 0x3C, 0x00, 0xFF},
		color.RGBA{0x8E, 0x60, 0x00, 0xFF},
		color.RGBA{0xB3, 0x84, 0x00, 0xFF},
		color.RGBA{0xD7, 0xAB, 0x00, 0xFF},
		color.RGBA{0xFE, 0xD1, 0x00, 0xFF},
		color.RGBA{0xFA, 0xFD, 0x38, 0xFF},
		color.RGBA{0x00, 0x24, 0x01, 0xFF}, // Green
		color.RGBA{0x00, 0x4B, 0x02, 0xFF},
		color.RGBA{0x00, 0x71, 0x05, 0xFF},
		color.RGBA{0x00, 0x99, 0x07, 0xFF},
		color.RGBA{0x00, 0xC0, 0x06, 0xFF},
		color.RGBA{0x00, 0xE6, 0x09, 0xFF},
		color.RGBA{0x4E, 0xFF, 0x25, 0xFF},
		color.RGBA{0xA2, 0xFF, 0x48, 0xFF},
		color.RGBA{0x41, 0x00, 0x00, 0xFF}, // Bright Orange
		color.RGBA{0x6C, 0x00, 0x00, 0xFF},
		color.RGBA{0x95, 0x0F, 0x00, 0xFF},
		color.RGBA{0xBC, 0x39, 0x00, 0xFF},
		color.RGBA{0xE2, 0x5E, 0x00, 0xFF},
		color.RGBA{0xFF, 0x83, 0x15, 0xFF},
		color.RGBA{0xFF, 0xAE, 0x4F, 0xFF},
		color.RGBA{0xFF, 0xDE, 0x80, 0xFF},
		color.RGBA{0x00, 0x28, 0x01, 0xFF}, // Green
		color.RGBA{0x00, 0x50, 0x03, 0xFF},
		color.RGBA{0x00, 0x79, 0x06, 0xFF},
		color.RGBA{0x00, 0x9F, 0x0B, 0xFF},
		color.RGBA{0x00, 0xC7, 0x23, 0xFF},
		color.RGBA{0x00, 0xEE, 0x41, 0xFF},
		color.RGBA{0x00, 0xFF, 0x62, 0xFF},
		color.RGBA{0x65, 0xFF, 0x8B, 0xFF},
		color.RGBA{0x4F, 0x00, 0x00, 0xFF}, // Pink
		color.RGBA{0x7E, 0x00, 0x00, 0xFF},
		color.RGBA{0xA6, 0x00, 0x11, 0xFF},
		color.RGBA{0xCF, 0x00, 0x38, 0xFF},
		color.RGBA{0xF8, 0x2F, 0x5D, 0xFF},
		color.RGBA{0xFF, 0x5C, 0x82, 0xFF},
		color.RGBA{0xFF, 0x8B, 0xAE, 0xFF},
		color.RGBA{0xFF, 0xB8, 0xD8, 0xFF},
		color.RGBA{0x00, 0x24, 0x01, 0xFF}, // Green blue
		color.RGBA{0x00, 0x4A, 0x07, 0xFF},
		color.RGBA{0x00, 0x72, 0x29, 0xFF},
		color.RGBA{0x00, 0x98, 0x49, 0xFF},
		color.RGBA{0x00, 0xBE, 0x6C, 0xFF},
		color.RGBA{0x00, 0xE6, 0x8F, 0xFF},
		color.RGBA{0x00, 0xFF, 0xB5, 0xFF},
		color.RGBA{0x41, 0xFF, 0xE0, 0xFF},
		color.RGBA{0x49, 0x00, 0x25, 0xFF}, // Pink Purple
		color.RGBA{0x78, 0x00, 0x4D, 0xFF},
		color.RGBA{0xA3, 0x00, 0x70, 0xFF},
		color.RGBA{0xCD, 0x00, 0x96, 0xFF},
		color.RGBA{0xF6, 0x00, 0xBB, 0xFF},
		color.RGBA{0xFF, 0x29, 0xE1, 0xFF},
		color.RGBA{0xFF, 0x6A, 0xFD, 0xFF},
		color.RGBA{0xFF, 0xA8, 0xFD, 0xFF},
		color.RGBA{0x00, 0x0F, 0x2B, 0xFF}, // Light blue
		color.RGBA{0x00, 0x33, 0x50, 0xFF},
		color.RGBA{0x00, 0x59, 0x77, 0xFF},
		color.RGBA{0x00, 0x7D, 0x9D, 0xFF},
		color.RGBA{0x00, 0xA2, 0xC2, 0xFF},
		color.RGBA{0x00, 0xC8, 0xE9, 0xFF},
		color.RGBA{0x00, 0xEF, 0xFF, 0xFF},
		color.RGBA{0x54, 0xFF, 0xFF, 0xFF},
		color.RGBA{0x36, 0x00, 0x66, 0xFF}, // Purple
		color.RGBA{0x63, 0x00, 0x93, 0xFF},
		color.RGBA{0x8C, 0x00, 0x8A, 0xFF},
		color.RGBA{0x83, 0x00, 0xE1, 0xFF},
		color.RGBA{0xDC, 0x00, 0xFF, 0xFF},
		color.RGBA{0xFF, 0x23, 0xFE, 0xFF},
		color.RGBA{0xFF, 0x6A, 0xFD, 0xFF},
		color.RGBA{0xFF, 0xA8, 0xFD, 0xFF},
		color.RGBA{0x18, 0x00, 0x6C, 0xFF}, // Blue
		color.RGBA{0x20, 0x00, 0x96, 0xFF},
		color.RGBA{0x22, 0x25, 0xBF, 0xFF},
		color.RGBA{0x2D, 0x4F, 0xE5, 0xFF},
		color.RGBA{0x3E, 0x77, 0xFF, 0xFF},
		color.RGBA{0x51, 0xA3, 0xFF, 0xFF},
		color.RGBA{0x6E, 0xD1, 0xFF, 0xFF},
		color.RGBA{0x90, 0xFD, 0xFF, 0xFF},
		color.RGBA{0x27, 0x00, 0x90, 0xFF}, // Purple
		color.RGBA{0x47, 0x00, 0xBF, 0xFF},
		color.RGBA{0x68, 0x00, 0xE7, 0xFF},
		color.RGBA{0x8A, 0x00, 0xFF, 0xFF},
		color.RGBA{0xAB, 0x00, 0xFF, 0xFF},
		color.RGBA{0xCF, 0x55, 0xFF, 0xFF},
		color.RGBA{0xF5, 0x88, 0xFE, 0xFF},
		color.RGBA{0xFF, 0xB7, 0xFE, 0xFF},
		color.RGBA{0x24, 0x00, 0x92, 0xFF}, // Light blue
		color.RGBA{0x33, 0x00, 0xC0, 0xFF},
		color.RGBA{0x47, 0x00, 0xE7, 0xFF},
		color.RGBA{0x5F, 0x00, 0xFF, 0xFF},
		color.RGBA{0x77, 0x49, 0xFF, 0xFF},
		color.RGBA{0x95, 0x7E, 0xFF, 0xFF},
		color.RGBA{0xB8, 0xAB, 0xFF, 0xFF},
		color.RGBA{0xDC, 0xD8, 0xFF, 0xFF},
		color.RGBA{0x00, 0x00, 0x00, 0xFF}, // Grey
		color.RGBA{0x1A, 0x1A, 0x1A, 0xFF},
		color.RGBA{0x39, 0x39, 0x39, 0xFF},
		color.RGBA{0x5B, 0x5B, 0x5B, 0xFF},
	...
	kSECAM = [128]color.RGBA{ // Same repeated every 8
		...
		color.RGBA{0x4E, 0x00, 0xFE, 0xFF}, // Blue
		color.RGBA{0xFF, 0x00, 0x6F, 0xFF}, // Red
		color.RGBA{0xFF, 0x00, 0xFE, 0xFF}, // Purple
		color.RGBA{0x00, 0xFF, 0x08, 0xFF}, // Green
		color.RGBA{0x2C, 0xFF, 0xFF, 0xFF}, // Turquoise
		color.RGBA{0x77, 0xFE, 0x27, 0xFF}, // Yellow
		color.RGBA{0xED, 0xED, 0xED, 0xFF}, // Light Grey
		color.RGBA{0x00, 0x00, 0x00, 0xFF}, // Black
		color.RGBA{0x4E, 0x00, 0xFE, 0xFF}, // Blue
		color.RGBA{0xFF, 0x00, 0x6F, 0xFF}, // Red
		color.RGBA{0xFF, 0x00, 0xFE, 0xFF}, // Purple
