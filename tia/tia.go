...
const (
	...
	// These are documented here but unused since they just overlap with the above indexes.
...
var (
	...
	kNTSC = [128]color.RGBA{
		...
		{0xFF, 0xB4, 0x0C, 0xFF},
		{0xFF, 0xE3, 0x65, 0xFF},
		{0x4F, 0x00, 0x00, 0xFF}, // Bright orange
		{0x7F, 0x00, 0x00, 0xFF},
		{0xA7, 0x00, 0x00, 0xFF},
		{0xD0, 0x06, 0x00, 0xFF},
		{0xF8, 0x3C, 0x0F, 0xFF},
		...
		{0xFF, 0x6C, 0xF5, 0xFF},
		{0xFF, 0xA8, 0xF6, 0xFF},
		{0x26, 0x00, 0x84, 0xFF}, // Purple-blue
		{0x47, 0x00, 0xA4, 0xFF},
		{0x6B, 0x00, 0xCB, 0xFF},
		{0x90, 0x00, 0xF3, 0xFF},
		{0xB3, 0x00, 0xFF, 0xFF},
		...
		{0x77, 0xCD, 0xFF, 0xFF},
		{0x9A, 0xF9, 0xFF, 0xFF},
		{0x03, 0x08, 0x3B, 0xFF}, // Light blue
		{0x01, 0x2A, 0x6F, 0xFF},
		{0x00, 0x4D, 0xA4, 0xFF},
		{0x00, 0x73, 0xCB, 0xFF},
		{0x00, 0x99, 0xF2, 0xFF},
		...
		{0x00, 0xFF, 0xED, 0xFF},
		{0x45, 0xFF, 0xFF, 0xFF},
		{0x00, 0x27, 0x04, 0xFF}, // Green blue
		{0x00, 0x4F, 0x08, 0xFF},
		{0x00, 0x77, 0x11, 0xFF},
		{0x00, 0x9E, 0x2F, 0xFF},
		{0x00, 0xC5, 0x4F, 0xFF},
		...
		{0x3D, 0xFF, 0x4A, 0xFF},
		{0x9B, 0xFF, 0x67, 0xFF},
		{0x00, 0x17, 0x01, 0xFF}, // Yellow green
		{0x00, 0x3A, 0x01, 0xFF},
		{0x13, 0x5E, 0x00, 0xFF},
		{0x3C, 0x84, 0x00, 0xFF},
		{0x5F, 0xAB, 0x00, 0xFF},
		...
		{0xA8, 0xF9, 0x03, 0xFF},
		{0xD8, 0xFF, 0x2E, 0xFF},
		{0x1E, 0x00, 0x00, 0xFF}, // Orange green
		{0x3F, 0x1E, 0x00, 0xFF},
		{0x62, 0x41, 0x00, 0xFF},
		{0x87, 0x65, 0x00, 0xFF},
		{0xAC, 0x8A, 0x00, 0xFF},
		...
		{0xF7, 0xD7, 0x00, 0xFF},
		{0xF9, 0xFF, 0x29, 0xFF},
		{0x3E, 0x00, 0x00, 0xFF}, // Light orange
		{0x68, 0x00, 0x00, 0xFF},
		{0x90, 0x16, 0x00, 0xFF},
		{0xB8, 0x3F, 0x00, 0xFF},
		{0xDF, 0x63, 0x00, 0xFF},
	...
	kPAL = [128]color.RGBA{
		...
		{0x4E, 0xFF, 0x25, 0xFF},
		{0xA2, 0xFF, 0x48, 0xFF},
		{0x41, 0x00, 0x00, 0xFF}, // Bright Orange
		{0x6C, 0x00, 0x00, 0xFF},
		{0x95, 0x0F, 0x00, 0xFF},
		{0xBC, 0x39, 0x00, 0xFF},
		{0xE2, 0x5E, 0x00, 0xFF},
		...
		{0xFF, 0x8B, 0xAE, 0xFF},
		{0xFF, 0xB8, 0xD8, 0xFF},
		{0x00, 0x24, 0x01, 0xFF}, // Green blue
		{0x00, 0x4A, 0x07, 0xFF},
		{0x00, 0x72, 0x29, 0xFF},
		{0x00, 0x98, 0x49, 0xFF},
		{0x00, 0xBE, 0x6C, 0xFF},
		...
		{0x00, 0xFF, 0xB5, 0xFF},
		{0x41, 0xFF, 0xE0, 0xFF},
		{0x49, 0x00, 0x25, 0xFF}, // Pink Purple
		{0x78, 0x00, 0x4D, 0xFF},
		{0xA3, 0x00, 0x70, 0xFF},
		{0xCD, 0x00, 0x96, 0xFF},
		{0xF6, 0x00, 0xBB, 0xFF},
		...
		{0xFF, 0x6A, 0xFD, 0xFF},
		{0xFF, 0xA8, 0xFD, 0xFF},
		{0x00, 0x0F, 0x2B, 0xFF}, // Light blue
		{0x00, 0x33, 0x50, 0xFF},
		{0x00, 0x59, 0x77, 0xFF},
		{0x00, 0x7D, 0x9D, 0xFF},
		{0x00, 0xA2, 0xC2, 0xFF},
		...
		{0xF5, 0x88, 0xFE, 0xFF},
		{0xFF, 0xB7, 0xFE, 0xFF},
		{0x24, 0x00, 0x92, 0xFF}, // Light blue
		{0x33, 0x00, 0xC0, 0xFF},
		{0x47, 0x00, 0xE7, 0xFF},
		{0x5F, 0x00, 0xFF, 0xFF},
		{0x77, 0x49, 0xFF, 0xFF},
	...
	kSECAM = [128]color.RGBA{ // Same repeated every 8
		...
		{0x4E, 0x00, 0xFE, 0xFF}, // Blue
		{0xFF, 0x00, 0x6F, 0xFF}, // Red
		{0xFF, 0x00, 0xFE, 0xFF}, // Purple
		{0x00, 0xFF, 0x08, 0xFF}, // Green
		{0x2C, 0xFF, 0xFF, 0xFF}, // Turquoise
		{0x77, 0xFE, 0x27, 0xFF}, // Yellow
		{0xED, 0xED, 0xED, 0xFF}, // Light Grey
		{0x00, 0x00, 0x00, 0xFF}, // Black
		{0x4E, 0x00, 0xFE, 0xFF}, // Blue
		{0xFF, 0x00, 0x6F, 0xFF}, // Red
		{0xFF, 0x00, 0xFE, 0xFF}, // Purple
